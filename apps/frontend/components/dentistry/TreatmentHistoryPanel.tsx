...
const createStyles = (theme: any) =>
  StyleSheet.create({
    ...
    currentLabel: { fontWeight: "700", opacity: 0.75 },
    currentValue: { fontWeight: "700" },
    empty: { fontWeight: "600", opacity: 0.6, paddingTop: 6 },
    itemRow: {
      borderWidth: 1,
      borderColor: theme.colors.border,
      borderRadius: 10,
    ...
    itemAt: { fontWeight: "700", fontSize: 12, opacity: 0.8 },
    itemProc: { fontWeight: "700", fontSize: 12 },
  });
