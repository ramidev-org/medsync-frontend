...
const createStyles = (theme: any) =>
  StyleSheet.create({
    ...
    statLabel: { color: theme.colors.textSecondary, fontWeight: "600", fontSize: 12 },
    statValue: { color: theme.colors.text, fontWeight: "700", fontSize: 24 },
    ...
    cardTitle: { color: theme.colors.text, fontWeight: "700", fontSize: 19 },
    cardIconWrap: {
      width: 42,
      height: 42,
      borderRadius: 14,
    ...
    roleCardTitle: { color: theme.colors.text, fontWeight: "700", fontSize: 15 },
    ...
    sectionTitle: { color: theme.colors.text, fontWeight: "700", fontSize: 18 },
    sectionCount: {
      color: theme.colors.primary,
      fontWeight: "700",
      fontSize: 22,
    ...
    personName: { color: theme.colors.text, fontWeight: "700", fontSize: 15, flexShrink: 1 },
    personMeta: {
      color: theme.colors.textSecondary,
      fontWeight: "700",
      marginTop: 4,
    ...
    modalTitle: { color: theme.colors.text, fontWeight: "700", fontSize: 20 },
    modalSubtitle: {
      color: theme.colors.textSecondary,
      fontWeight: "700",
      marginTop: 4,
    ...
    modalAvatarText: { color: theme.colors.primary, fontWeight: "700", fontSize: 18 },
    modalName: { color: theme.colors.text, fontWeight: "700", fontSize: 18 },
    ...
    emptyTitle: { color: theme.colors.text, fontWeight: "700", fontSize: 15 },
    emptyText: {
      color: theme.colors.textSecondary,
      fontWeight: "700",
      lineHeight: 20,
