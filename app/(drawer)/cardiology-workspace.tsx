  ...
  return (
    <PageShell>
      <WorkspaceHero
        ...
        subtitle="Structured cardiology note capture (complaint → vitals → assessment → plan)."
      />

      <WorkspaceSurface theme={theme} title="Cardiology" subtitle="Capture key elements quickly with structured fields.">
        <View style={{ gap: 2 }}>
          ...
          <View style={{ padding: 12, borderWidth: 1, borderColor: theme.colors.border, borderRadius: 14, backgroundColor: theme.colors.background }}>
            <Text style={{ fontWeight: "900", color: theme.colors.text }}>Next</Text>
            <Text style={{ marginTop: 6, fontWeight: "700", color: theme.colors.textSecondary }}>
              Tell me which cardiology steps you want (ECG upload, echo metrics, meds list, risk scores) and I’ll turn this into a step-based flow like Gynecology.
            </Text>
          </View>
        </View>
      </WorkspaceSurface>
