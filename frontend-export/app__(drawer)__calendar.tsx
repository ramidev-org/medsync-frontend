...
export default function CalendarPage() {
  ...
  }, [selectedDate, user?.id, reloadTick]);
  ...
  return (
    <>
      ...
      >
        ...
        {error ? (
          <View style={[styles.errorBanner, { borderColor: theme.colors.error, backgroundColor: `${theme.colors.error}12` }]}>
            <Ionicons name="alert-circle-outline" size={18} color={theme.colors.error} />
            <Text style={[styles.errorText, { color: theme.colors.error, flex: 1 }]}>{error}</Text>
            <TouchableOpacity onPress={() => setReloadTick((t) => t + 1)}>
