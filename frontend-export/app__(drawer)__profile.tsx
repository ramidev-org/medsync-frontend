            ...
            {activeTab === "personal" && (
              <>
                ...
                <View style={[styles.row, isCompact && styles.rowStack]}>
                  ...
                  <View style={styles.fieldCol}>
                    <Field label="Username" value={username} onChangeText={setUsername} theme={theme} editable={isEditing} autoCapitalize="none" />
                  </View>
                </View>
                <View style={[styles.row, isCompact && styles.rowStack]}>
                  <View style={styles.fieldCol}>
            ...
            {activeTab === "doctor" && user?.user_type === "doctor" && (
              <>
                ...
                <View style={[styles.row, isCompact && styles.rowStack]}>
                  ...
                  <View style={styles.fieldCol}>
                    <Field label="License Number" value={doctorLicense} onChangeText={setDoctorLicense} theme={theme} editable={isEditing} autoCapitalize="none" />
                  </View>
                </View>
                <View style={[styles.row, isCompact && styles.rowStack]}>
                  <View style={styles.fieldCol}>
            ...
            {activeTab === "doctor" && user?.user_type !== "doctor" && (
              <>
                ...
                <View style={[styles.row, isCompact && styles.rowStack]}>
                  ...
                  <View style={styles.fieldCol}>
                    <Field label="Shift Start (HH:MM)" value={assistantShiftStart} onChangeText={setAssistantShiftStart} theme={theme} editable={isEditing} autoCapitalize="none" />
                  </View>
                </View>
                <View style={[styles.row, isCompact && styles.rowStack]}>
                  <View style={styles.fieldCol}>
                    <Field label="Shift End (HH:MM)" value={assistantShiftEnd} onChangeText={setAssistantShiftEnd} theme={theme} editable={isEditing} autoCapitalize="none" />
                  </View>
                </View>
              </>
            )}
