              ...
              <ScrollView style={styles.tableScroll} showsVerticalScrollIndicator={false}>
                ...
                {appointmentsLoading ? (
                  <View style={styles.emptyTable}>
                    ...
                    <Text style={styles.emptyText}>Chargement des rendez-vous…</Text>
                  </View>
                ) : filteredAppointments.length === 0 ? (
                  <View style={styles.emptyTable}><Ionicons name="calendar-clear-outline" size={28} color={theme.colors.muted} /><Text style={styles.emptyText}>Aucun rendez-vous pour ce filtre.</Text></View>
                ) : null}
              </ScrollView>
...
const createStyles = (theme: any) => StyleSheet.create({
    ...
    tableRow: { minHeight: 72, flexDirection: "row", alignItems: "center", paddingHorizontal: 18, borderBottomWidth: 1, borderBottomColor: theme.colors.borderSubtle },
