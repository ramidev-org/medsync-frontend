...
export default function PatientsPage() {
  ...
  useEffect(() => {
    // Typing in the search box or changing the date range re-triggers this
    // on every change - without a guard, a slower response for an earlier
    // keystroke could resolve after a faster one and overwrite the list
    // with results for a search term the user has already changed.
    const cancelledRef = { current: false };
    fetchRows(cancelledRef);
    return () => {
